...
def all_train_data_to_pickle_with_pinyin(data_path, output_dir, vocab_path, max_len ):
    ...
    train_all = _build_dataset(data_path=os.path.join(data_path, 'train.isolation.tsv')) # 198050
    ...
    write_data_to_txt(train_all, os.path.join(output_dir, 'train_all_isolation'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default="../../data/processed_isolation/train_isolation/")
